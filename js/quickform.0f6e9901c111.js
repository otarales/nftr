...
(function($) {
    ...
    function onPlaceCountry(form) {
        var select = form.find("select[name='country_code']")[0];
    ...
    function setupCountryCodeEventListeners() {
        var forms = $(".search-form");
        forms.each(function() {
            var form = $(this);
    ...
    function selectPlaceCountryDefaults() {
        ...
        forms.each(function() {
            ...
            if (!country_code) {
                form.find("input[name='country_code']").val('US');
            }
        });
    }
    ...
    $(window).ready(function() {
        ...
        setupOnlineProviderEventListeners();
        setupCountryCodeEventListeners();
