...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                ...
                                ?>  
                                                        ...
                                                        <h4>Recent Posts Orders (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                              ...
                                              '<div class="comment-body">
                                                            <div class="mail-contnet">
                                                                <b>'.$row["name"].'</b>
                                                                <h5>Nft Title : '.$row2["title"].'</h5>
                                                                <h5>Amount Paid : '.$row["amount"].'</h5>
                                                                <h5>Buyers Address : '.$row["wallet_address"].'</h5>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2022 &copy; Evoverz Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
