                                    ...
                                    <div class="inbox-center">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Posts (<b style="color: orange;"><?php echo mysqli_num_rows($query);?></b>)</h4>
                                                        <?php 
                                                             if (mysqli_num_rows($query)==0) {
                                                    echo "<i style='color:brown;'>No Posts Yet :( Upload nftresourcex's first post today! </i> ";}
                                                        ?>
                                                    </th>
                                                </tr>
                                            </thead>
