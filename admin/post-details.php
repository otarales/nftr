    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                  ...
                  <li> <a href="#" class="waves-effect active"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Post<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Nft Post Detail</li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                            ...
                            <div class="row">
                                ...
                                '<div class="col-lg-12 col-md-9 col-sm-8 col-xs-12 mail_listing">
                                    <div class="media m-b-30 p-t-20">
                                        ...
                                        <i style="float:right; font-size:15px; color:orange;">Orders: '.mysqli_num_rows($query2).'</i>
                                        </h4>
                                        <hr>
                                        <div class="single-post-media">
                                        <img src=" ../upload/'.$row["imgFullName"].'" alt="nfts" class="img-fluid">
                                        </div>
                                        <hr>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2021 &copy; nftresourcex Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
