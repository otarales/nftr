                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">nftresourcex Users ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
                            ...
                            <div class="table-responsive">
                                <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    echo '
                                        ...
                                        <tr>
                                            <td>'.$row["username"].'</td>
                                            <td>'.$row["justdeposit"].'</td>
                                            <td>'.$row["endprofit"].'</td>
                                            <td>'.$row["totaldeposit"].'</td>
                                            <td>'.$row["nftbought"].'</td>
                                            <td>'.$row["per"].'</td>
                                            <td>
                                            <a href="client-detail.php?id='.$row["id"].'"><i class="fas fa-edit"></i></a>
                                            <a href="#"><i class="fa fa-trash"  data-toggle="modal" data-target="#responsive-modal'.$row["id"].'" title="remove" style="color:red;"></i></a></td>
