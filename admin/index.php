...
<head>
    ...
    <title>nftresourcex.com: Admin</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li><a href="inbox.php" class="waves-effect"><i data-icon=")" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Messages</span></a>
                    ...
                    <li><a href="newp.php" class="waves-effect"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Subscribers</span></a>
                    </li>
        ...
        <div id="page-wrapper">
                        ...
                        <div class="white-box">
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">nftresourcex Posts</h5> </div>
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe01b;"></i>
                                            <h5 class="text-muted vb">Post Orders</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-lg-3 col-sm-6  b-0">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i class="linea-icon linea-basic" data-icon="&#xe016;"></i>
                                            <h5 class="text-muted vb">Evoverz Subscribers</h5> </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center">
                                <div class="comment-body">
                                    ...
                                    ?>
                                    <hr>
                                     <a href="comments.php" class="btn btn-info btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">View All Orders</a>
                                    </div>
                    ...
                    <div class="col-md-12 col-lg-6 col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="row sales-report">
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h2>nftresourcex Admin Panel</h2>
                                    <p>Posts</p>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-6 ">
                                ...
                                <table class="table ">
                                    ...
                                    <?php
                                             if (mysqli_num_rows($query_posts)==0) {
                                                 echo "<i style='color:brown;'>No Posts Yet :( Upload nftresourcex.com's first Nft collection today! </i> ";
                                                    }
                                                    else
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2022 &copy; nftresourcex.com Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        $.toast({
            heading: 'Welcome to nftresourcex.com Admin',
